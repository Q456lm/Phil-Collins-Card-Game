public class card{
    ...
    public String toString(){
        if (cardType == 1){
            ...
            return "Another Day In Paradise - All Players except you deposit one card.";
        }else if (cardType == 5){
            return "One More Night - If you have 2 cards or less (after using this card), draw 6 cards.";
        }else if (cardType == 6){
            ...
            return "I Wish It Would Rain Down - Pick a Player and Steal two of their cards";
        }else if (cardType == 11){
            return "Do You Remember? - Look at another player's cards.";
        }else if (cardType == 12){
